...
Original file is located at
    https://colab.research.google.com/drive/19vxEZVi4JSUpIs1il9Q-mfzEEXaTBNUq
"""

import pandas as pd

dados = pd.read_csv('gatosCachorros.csv',sep=';')
dados.info()
...
if st.button('Rodar a árvore'):
    ...
    st.write('O animal previsto pela árvore é: '+int(predicao))
